...
# Large, varied phrase libraries so the coach never sounds like a robot on repeat.
VOICE_OPEN = ["Okay, look at this.","Wait — pause here.","Hey, quick one.","Alright, eyes up.","Hold on a sec.","Right, here's the thing.","Notice something?","Let me stop you.","Okay okay okay.","Check this out.","Before you move —","Hmm, interesting.","See it?","One second —","Look what just happened.","Ooh, careful here."]
VOICE_GOOD = ["Yes! That's it.","Beautiful.","Clean move.","Ohh, nice.","Exactly right.","That's the one.","Love it.","Perfect.","That's engine-approved.","Textbook.","Big brain move.","See, you've got this.","Sharp.","Now we're cooking.","That's a coach's move.","Yep — I'd play that too."]
VOICE_BAD  = ["Oh no, wait.","Ohh, hold on.","Yikes.","Mmm, careful.","Wait wait wait.","Uh oh.","Hmm, not sure about that.","Ooh, that one stings.","Let's rewind.","Careful, careful.","That's gonna hurt.","Oof.","Hold up.","No no no — look.","Ahh, that's a slip.","Not that one."]
VOICE_TACTIC = ["There's a tactic here — feel it.","Something's hanging in the air.","Sharp position — calculate.","There's a shot here.","Pieces are loaded — find the hit.","Concrete moment. Count it out.","This screams tactics.","Forcing move somewhere — checks first.","The position's begging for a combination.","Don't play safe — there's a punch.","Look for the fork, the pin, the skewer.","Someone's about to win material.","Tactics before strategy here.","Eyes on every check and capture.","Calculate, don't guess.","There's a tell — find the loose piece."]
VOICE_POS  = ["Quiet spot — improve a piece.","No fireworks. Just good chess.","Slow position. Think plans.","Where's your worst piece?","Nothing forcing — build.","Strategic moment. Breathe.","Which of your pieces is sad?","Maneuvering time.","Small edges add up here.","Trade your bad piece for their good one.","Space, structure, squares — that's the game now.","Patience — this isn't ready to explode.","Ask what the position wants.","Long-game thinking here.","Reposition, then strike.","Keep the tension — don't rush to trade."]
VOICE_CRIT = ["THIS is the moment.","Okay — the game turns here.","Don't rush this one.","Critical. Slow way down.","Everything hinges on this move.","This is where games are won or lost.","Take your time — big decision.","Deep breath. This one matters.","The whole plan lives or dies here.","Make it count.","This is a thinking move, not a reflex.","Get this right and you're winning.","Fork in the road — choose well.","No autopilot here.","This is the position to remember.","Precision now."]
VOICE_THREAT = ["See what their last move threatens?","That wasn't random — they're threatening something.","They just set something up — spot it.","Notice the threat before you plan your own.","Their move attacks — what, exactly?","You're being threatened. Defend or counter first.","They've got ideas. What are they?","Careful — their last move has teeth.","Don't ignore what they just did.","They're coming for something. Find it."]
SOCRATIC = ["What's their move threatening?","What's your worst piece right now?","Any checks, captures, or threats for YOU?","If you do nothing, what happens?","Which of your pieces is undefended?","Where does their king want to hide?","What's the one move you'd hate them to play?","Can you improve a piece for free?","Is your king safe enough to attack?","What did their last move give up?","Where's the weakest square in their camp?","Trade, push, or wait — which, and why?"]
